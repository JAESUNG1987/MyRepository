			...
			if (choice.equals("1")) {	// 목록보기
				...
				for(MessageBoard messageBoard : messageBoards) {
					if (messageBoard != null) {
						System.out.println(messageBoard.getNo() + "\t\t" + messageBoard.getTitle() + "\t\t" + messageBoard.getName() + "\t\t" + messageBoard.getCount());
					}
				}
				...
				if (messageBoards != null) {		
					for (MessageBoard messageBoard : messageBoards) {
						if (messageBoard != null) {
							if(detailNum == messageBoard.getNo()){ 
								messageBoard.setCount(messageBoard.getCount()+1);;
								System.out.println("***************************************************");
								System.out.println("번호\t\t제목\t\t내용\t\t글쓴이\t\t조회수");
								System.out.println("***************************************************");
								System.out.println(messageBoard.getNo() + "\t\t" + messageBoard.getTitle() + "\t\t" + messageBoard.getText() + "\t\t" + messageBoard.getName() + "\t\t" + messageBoard.getCount());
							}
						}
					}
				}
				...
				if (messageBoards != null) {
					for (MessageBoard messageBoard : messageBoards) {
						if (messageBoard != null) {
							if(modifyNum == messageBoard.getNo()){
								System.out.print("제목 : ");
								String title = scanner.nextLine();
								System.out.print("내용 : ");
								String text = scanner.nextLine();
