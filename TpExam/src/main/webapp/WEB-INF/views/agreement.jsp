			...
			<div class="content_area_scroll">
				...
				<div class="content_inner">
					...
					<div class="terms_scrollbox">
						<strong>제1조(목적 등)</strong>① ADT 뷰가드 웹관제(www.capslive.co.kr) 서비스
						약관(이하 "본 약관"이라 합니다)은 이용자가 주식회사 에이디티캡스(이하 "ADT캡스"라 합니다)에서 제공하는 인터넷
						관련 서비스(이하 "서비스"라 합니다)를 이용함에 있어 이용자와 ADT캡스의 권리,의무 및 책임사항을 규정함을 목적으로
						합니다. <br>② 이용자가 되고자 하는 사람이 ADT캡스가 정한 회원약관에 동의를 확인하는 페이지에서
						"회원약관에 동의"를 선택 한 경우에만 회원가입정보를 입력하는 페이지로 화면이 이동할 수 있으며, "회원약관에 동의"를
						선택 한 후 "다음단계"를 누르면 본 약관에 동의하는 것으로 간주합니다. 본 약관에 정하는 이외의 이용자와 ADT캡스의
						권리, 의무 및 책임에 관해서는 약관의규제에관한법률, 전기통신사업법 기타 대한민국의 관련 법령과 상관습에 의합니다. <br>
						<br> <strong>제2조(이용자의 정의)</strong>① "이용자"란 ADT캡스에 접속하여 본 약관에
						따라 ADT캡스 회원으로 가입하여 ADT캡스가 제공하는 서비스를 받는 자를 말합니다.<br> <br>
						<strong>제3조(회원 가입)</strong>① 이용자가 되고자 하는 사람은 ADT캡스가 정한 가입 양식에 따라
						ADT캡스가 제공하는 각종 서비스를 받기 위한 회원정보를 기입하고 "가입하기" 단추를 누르는 방법으로 회원가입신청 및
						가입이 이루어지며 회원가입 시 ADT캡스에 회원정보의 제공을 동의한 경우에는 제2항의 회원정보의 공유에도 동의한 것으로
						간주합니다. <br>② ADT캡스는 제1항과 같이 회원으로 가입할 것을 신청한 자가 다음 각 호에 해당하지
						않는 한 신청한 자를 회원으로 등록합니다.<br>ⅰ) 가입신청자가 본 약관 제6조 제3항에 의하여 이전에
						회원자격을 상실한 적이 있는 경우. 다만 제6조 제3항에 의한 회원자격 상실 후 3년이 경과한 자로서 ADT캡스의 회원
						재가입 승낙을 얻은 경우에는 예외로 합니다.<br>② ADT캡스는 제1항과 같이 회원으로 가입할 것을 신청한
						...
						자로서 ADT캡스의 회원 재가입 승낙을 얻은 경우에는 예외로 합니다.<br>ⅱ) 등록 내용에 허위, 기재누락,
						오기가 있는 경우 <br>ⅲ) 기타 회원으로 등록하는 것이 ADT캡스의 기술상 현저히 지장이 있다고 판단되는
						경우 <br>③ 회원가입의 성립시기는 이용자의 입력정보가 ADT캡스의 데이터베이스에 저장된 시점으로 합니다.<br>④
						회원은 제1항의 회원정보 기재 내용에 변경이 발생한 경우, 즉시 변경사항을 정정하여 기재하여야 합니다.<br>⑤14세
						미만 회원은 가입하실 수 없습니다.<br> <br> <strong>제4조(서비스의
							제공 및 변경)</strong>① ADT캡스는 이용자에게 아래와 같은 서비스를 제공합니다.<br>ⅰ) ADT캡스가 자체
						개발하거나 다른 회사와의 협력계약 등을 통해 회원들에게 제공할 일체의 서비스<br>② ADT캡스는 그 변경될
