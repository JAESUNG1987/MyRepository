			...
			<div class="content_area_scroll"><!-- 스크롤 처리되는 div -->
				...
				<div class="content_inner">
					<form name="noticeForm" id="noticeForm" method="post">
						...
						<fieldset class="srch">
							<legend>검색영역</legend>
							<input name="search" title="검색어" class="keyword" accesskey="s"
								type="text" placeholder="Search" value=""> <input
								type="image" alt="검색" src="../img/sub/src_icon.png"> <span></span>
						</fieldset>
						...
						<table class="tb0_style">
							...
							<tbody>
								...
								<tr>
									<td>11</td>
									<td><a href="/?cont=c051&amp;idx=2692&amp;pageNum=1">NVR
											간편 사용 설명서</a></td>
									<td>2015-03-17</td>
								</tr>
						...
						<div class="paginate01">
							<a class="direction prevp" href="/?cont=c05">처음</a> <a href="#"
								class="active">1</a> <a
								href="JavaScript:goList('noticeForm', '/?cont=c05', 2)">2</a> <a
								class="direction nextn" href="/?cont=c05&amp;pageNum=2">끝</a>
						</div>
						<!--공지사항리스트 내용끝-->
					</form>
				</div>
