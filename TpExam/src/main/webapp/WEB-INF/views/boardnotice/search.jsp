		...
		<DIV class="content_area">
			...
			<div class="content_area_scroll"><!-- 스크롤 처리되는 div -->
				...
				<div class="content_inner">
					...
					<table class="tb2_style">
						...
						<tbody>
							...
							<tr>
								<td colspan="2">
								<p>
									<br>${boardnotice.bcontent}<img src="<%=pageContext.getServletContext().getContextPath()%>/resources/capsimages/main/banner02.png"><br>
								</p>
							</td>
							</tr>
						</tbody>
					...
					<table class="tb3_style">
						<colgroup>
						<col style="width:120px;"><col style="width:550px;">
						</colgroup>
						<tbody>
							<tr>
								<th>이전글</th>
								
								<td><a href="info?bno=${boardnotice.bno}">${boardnotice.btitle}</a></td>
								
							</tr>
							<tr>
								<th>다음글</th>
								
								<td><a href="">${boardnotice.btitle}</a></td>
					...
					<a href="modify?bno=${boardnotice.bno}">[수정]</a>
