...
public class MemberController {
	...
	public String login(String mid, String mpassword, HttpSession session, Model model){
		...
		System.out.println(member.getMlevel());
		if(result == MemberService.LOGIN_FAIL_MID){
			model.addAttribute("err", "LOGIN_FAIL_MID");
			return "member/loginForm";
		}else if(result == MemberService.LOGIN_FAIL_MPASSWORD){
			model.addAttribute("err", "LOGIN_FAIL_MPASSWORD");
			return "member/loginForm";
		}else{
