...
public class BoardNoticeController {
	...
	public String list(String pageNo, Model model, HttpSession session){
		...
		int totalBoardNoticeNo = boardNoticeService.getcount();
		...
		List<BoardNotice> list = boardNoticeService.list(intPageNo, rowsPerPage);
	...
	public String searchbefore(){
		return "boardnotice/search";
	}
	/*
	@RequestMapping(value="/search", method=RequestMethod.POST)
	public String searchbefore(int bno, Model model){
		BoardNotice boardNotice = boardNoticeService.search(bno);
		boardNotice.setBno(boardNotice.getBno()-1);
		boardNoticeService.search(boardNotice.getBno());
