			...
			<div class="content_area_scroll"><!-- 스크롤 처리되는 div -->
				...
				<div class="content_inner">
					<form name="noticeForm" id="noticeForm" method="post">
						...
						<h2>A/S 문의</h2>
						<a class="btn btn-primary btn-sm" href="write" style="position: relative; float: right; color: #fff">
							글 쓰기
						</a>
						...
						<div id="pagenum" style="width: 600px; padding-top: 20px; line-height: normal; text-align: center;">
							<a href="list?pageNo=1">[처음]</a>
								...
								<c:forEach var="i" begin="${startPageNo}" end="${endPageNo}">
									<a href="list?pageNo=${i}" <c:if test="${pageNo==i}"> style="color:red"</c:if>>
										${i}
									</a>&nbsp;
								</c:forEach>
