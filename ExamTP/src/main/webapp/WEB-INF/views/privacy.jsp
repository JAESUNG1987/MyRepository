...
<BODY oncontextmenu="return false">
	...
	<section id="container" style="position: fixed; min-height:">
		<!--header 시작-->
		<DIV class="header">
		...
		<DIV class="content_area">
			...
			<div class="content_area_scroll">
				...
				<h2>개인정보취급(처리)방침</h2>
					...
					<!--개인정보 취급방침 내용시작-->
					<div class="terms_scrollbox">
						주식회사 에이디티캡스(이하 “ADT캡스”라고 한다)는 고객의 개인정보를 철저히 보호하고 있으며, "개인정보 보호법"과 "정보통신망 이용촉진 및 정보보호에 관한 법률"(이하 “정보통신망법”)을 성실히 준수하고 있습니다. ADT캡스는 개인정보 보호법 제30조 및 정보통신망법 제27조의2에 따라 개인정보 취급(처리)방침을 통하여 고객께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.<br><br>
							<strong>제 1 조 (수집하는 개인정보 항목 및 수집방법)</strong>
							ADT캡스가 처리하는 개인정보의 항목과 수집방법은 다음과 같습니다.<br>
					...
					ADT캡스는 수집한 개인정보를 다음 각 호의 이용 목적을 위해 활용합니다.<br>
					...
					ADT캡스는 개인정보의 수집,이용에 관한 동의일로부터 위 이용목적을 달성할 때까지 고객의 개인정보를 보유, 이용합니다.<br><br>
					<strong>제 4 조 (개인정보의 안전성 확보조치)</strong>
					ADT캡스 는 다음 각 호와 같이 안전성 확보에 필요한 기술적, 관리적, 물리적 조치를 취하고 있습니다 .<br>
					...
					① ADT캡스 는 원칙적으로 고객의 개인정보를 제 2조에서 명시한 목적 범위 내에서 처리하며 , 고객의 사전 동의 없이는 본래의 범위를 초과하여 처리하거나 제 3자에게 제공하지 않습니다 . 단, 다음의 각 호의 경우에는 고객 또는 제 3자의 이익을 부당하게 침해할 우려가 있을 때를 제외하고는 개인정보를 목적 외의 용도로 이용하거나 이를 제 3자에게 제공할 수 있습니다.<br>
					...
					② ADT캡스 는 제 1항 제 1호에 따른 동의를 받을 때에는 다음 각 호의 사항을 고객 에게 알립니다 . 다음 각 호의 어느 하나의 사항을 변경하는 경우에도 이를 고객 에게 알리고 동의를 받습니다.<br>
					1. 개인정보를 제공받는 자<br>
					...
					① ADT캡스 는 다음과 같이 개인정보 취급 업무를 위탁하고 있습니다. 향후 수탁업체 및 위탁하는 업무의 내용이 변경될 경우 지체 없이 본 방침을 통해 고지하겠습니다.<br>
					<table class="tb5_style">
						<colgroup>
					...
					② ADT캡스는 수탁업체와의 위탁계약 체결 시 관련 법령에 따라 위탁업무 수행목적 외 개인정보 처리금지 , 기술적,관리적,물리적 보호조치 , 위탁업무의 목적 및 범위 , 재위탁 제한 , 개인정보에 대한 접근제한 등 안전성 확보 조치에 관한 사항 , 위탁업무와 관련하여 보유하고 있는 개인정보의 관리 현황 점검 등 감독에 관한 사항 , 수탁자가 준수하여야 할 의무를 위반한 경우의 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고 , 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.<br><br>
					<strong>제 7 조 (개인정보의 파기)</strong>
					① ADT캡스는 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 분쟁 해결 , 민원처리 , 법령상 의무이행 및 리스크 관리업무 등을 위하여 개인정보의 보존이 필요한 경우에는 다른 정보주체의 개인정보와 분리하여 별도로 저장 및 관리 할 수 있습니다 .<br>② ADT캡스는 개인정보가 기록된 출력물 , 서면 등은 파쇄 또는 소각의 방법으로 파기하고 , 전자적 파일형태의 개인정보는 복원이 불가능한 방법으로 영구 삭제하는 방법으로 파기합니다.<br><br>
					<strong>제 8 조 (고객의 권리와 그 행사방법)</strong>
					① 고객은 ADT캡스가 처리하는 자신 및 14 세 미만 아동 (법정대리인만 해당 )의 개인정보의 열람을 요구할 수 있습니다 .<br>② 자신의 개인정보를 열람한 고객은 사실과 다르거나 확인할 수 없는 개인정보에 대하여 ADT캡스에 정정 또는 삭제를 요구할 수 있습니다 . 다만 , 다른 법령에서 그 개인정보가 수집 대상으로 명시되어 있는 경우에는 그 삭제를 요구할 수 없습니다 .<br>③ 고객은 ADT캡스에 대하여 자신의 개인정보 처리의 정지를 요구할 수 있습니다 . 다만 , 다음 각 호의 어느 하나에 해당하는 경우에는 ADT캡스는 해당 사유를 고객에게 알리고 , 처리정지 요구를 거절할 수 있습니다 .<br>1. 법률에 특별한 규정이 있거나 법령상 의무를 준수하기 위하여 불가피한 경우<br>2. 다른 사람의 생명, 신체를 해할 우려가 있거나 다른 사람의 재산과 그 밖의 이익을 부당하게 침해할 우려가 있는 경우<br>3. 개인정보를 처리하지 아니하면 고객과 약정한 서비스를 제공하지 못하는 등 계약의 이행이 곤란한 경우로서 고객이 그 계약의 해지 의사를 명확하게 밝히지 아니한 경우<br><br>
					<strong>제 9 조 (인터넷 접속정보파일 등 개인정보를 자동으로 수집하는 장치의 설치,운영 및 그 거부에 관한 사항)</strong>
					ADT캡스는 고객의 정보를 수시로 저장하고 찾아내는 ‘쿠키(cookie)’ 등 개인정보를 자동으로 수집하는 장치를 설치,운용하고 있지 않습니다<br><br>
					<strong>제 10 조 (개인정보 관리(보호)책임자)</strong>
					① ADT캡스는 고객의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 다음과 같이 관련 부서 및 개인정보 관리 (보호)책임자를 지정하고 있습니다.<br>
					...
					ADT캡스는 개인정보 취급 (처리 )방침을 변경하는 경우에 변경 및 시행의 시기 , 변경된 내용을 지속적으로 공개하며 , 변경된 내용은 고객이 쉽게 확인할 수 있도록 변경 전,후를 비교하여 공개합니다 .<br>
