...
public class RoomController {
	...
	@Autowired
	private FlameService fireService;
	...
	public String roomInfo(int rid, Model model){
		...
		logger.info("gas : " + gas.getGgas());
		
		Flame flame = fireService.info(rid);
		logger.info("fire : " + flame.getFflame());
