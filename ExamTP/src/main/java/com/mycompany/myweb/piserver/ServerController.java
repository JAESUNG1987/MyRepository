...
public class ServerController {	
	...
	public void AcceptPostFlame(int frid, double fflame, HttpServletResponse response) throws Exception {
		////////////////////////////////////////////////////////
		// 화재 감지 센서 관련
		////////////////////////////////////////////////////////
        Date dateEventTime = new Date();
	...
	public void AcceptPostGas(int grid, double ggas, HttpServletResponse response) throws Exception {
		////////////////////////////////////////////////////////
		// 가스 발생 센서 관련
		////////////////////////////////////////////////////////
        Date dateEventTime = new Date();
