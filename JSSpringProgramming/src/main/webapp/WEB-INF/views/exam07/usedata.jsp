...
<%@ page import="com.mycompany.jsapp.exam07.*"%>
...
<html>
	...
	<body>
		...
		데이터1: <%=(String)request.getAttribute("data01")%><br/>
		데이터2: <%=(String)request.getAttribute("data02")%><br/><br/>
		[HttpSession를 이용해서 찾기] <br/>
		데이터1: <%=(String)session.getAttribute("data01")%><br/>
		데이터2: <%=(String)session.getAttribute("data02")%><br/><br/>
		[EL을 이용해서 찾기]<br/>
		데이터1: ${data01}<br/>
		데이터2: ${data02}<br/><br/>
