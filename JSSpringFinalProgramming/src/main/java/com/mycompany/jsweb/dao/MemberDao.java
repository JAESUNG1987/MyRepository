package com.mycompany.jsweb.dao;
...
import com.mycompany.jsweb.dto.Member;
...
public class MemberDao {
	...
	public String selectByMPassword(String mpassword){
		String sql = "select mpassword from member where mid=? and memail=?";
		List<String> list = jdbcTemplate.query(sql, new Object[] {mpassword}, new RowMapper<String>(){
			@Override
			public String mapRow(ResultSet rs, int row) throws SQLException {
