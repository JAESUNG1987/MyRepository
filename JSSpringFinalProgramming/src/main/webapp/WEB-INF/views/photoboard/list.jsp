				...
				<td>
					<c:forEach var="photoBoard" items="${list}">
						<a href="info?bno=${photoBoard.bno}">
							<div style="width:150px; height:170px; margin:5px; display:inline-block; background-image:url(showPhoto?savedfile=${photoBoard.savedfile}); background-size: 150px 170px;">
